    ...
    <section id="shop" className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {showcaseMedicines.map((item) => (
            <Link
              ...
              key={item.slug}
              className="p-4 flex gap-4 items-start rounded-md border bg-white border-gray-200 hover:shadow-md transition-shadow group"
            >
              <div
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2 mb-0.5">
                  <p className="font-semibold text-sm text-foreground leading-tight hover:text-primary transition-colors line-clamp-1">
                    {item.name}
                  </p>
                  {item.badge && (
                    <Badge
      ...
      <div>
        <div className="flex items-center gap-2 mb-5">
          ...
          <span className="text-xs text-muted-foreground">
            Platform&apos;s own health products
          </span>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {products.map((p) => (
            ...
            >
              ...
              <Badge className="bg-muted text-muted-foreground border-0 text-xs mb-2">
                {p.category}
              </Badge>
              <h4 className="font-semibold text-sm text-foreground mb-3 leading-tight">
                {p.name}
              </h4>
              <div className="flex items-center justify-between">
